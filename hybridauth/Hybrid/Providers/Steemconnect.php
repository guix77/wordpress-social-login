...
class Hybrid_Providers_Steemconnect extends Hybrid_Provider_Model_OAuth2
{
	...
	*/
	function initialize()
	{
		...
		$this->api->api_base_url  = "https://app.steemconnect.com/api/";
		$this->api->authorize_url = "https://app.steemconnect.com/oauth2/authorize";
		$this->api->token_url     = "https://app.steemconnect.com/api/oauth2/token";
